...
public class AntrianFragment extends Fragment {
    ...
    public static AntrianFragment newInstance(String username, String password) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView otp1 = view.findViewById(R.id.otp1);
        otp1.setText(username_lg + password_lg);
        return view;
    }
